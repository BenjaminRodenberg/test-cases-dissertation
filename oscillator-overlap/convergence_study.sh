. .venv/bin/activate
# Figure 6.1
python3 doConvergenceStudy.py precice-config-template.xml --silent --executor Github -tss runge_kutta_4 generalized_alpha -wd 3 -dt 0.05 -sb 4 4 -s 8 -sf 1 2 -w 1 -o convergence-studies/subcycling_rk4_ga.csv
...
# # Figure 6.2a
# python3 doConvergenceStudy.py precice-config-template.xml --config fig6_2a_config.csv -tss runge_kutta_4 generalized_alpha -wd 3 -o convergence-studies/contour_data.csv
# # Figure 6.2b
